...
function evolution_vaccination()
    ...
    rewards_of_neighbors_V = conv2(system.reward_vacc.*system.vaccinated,filter,'same');
    ...
    system.reward_vacc = system.reward_vacc + ((system.state == "S") & (system.vaccinated == true)) * r_vacc;
